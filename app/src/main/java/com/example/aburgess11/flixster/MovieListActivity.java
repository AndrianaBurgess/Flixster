...
public class MovieListActivity extends AppCompatActivity {
   ...
   //tag for logging from this activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //init adapter - movies cant be reinit after
        adapter = new MovieAdapter(movies);


        //resolve the recycler and connect a layout manger and the adapter
              ...
              // log the results into movie list
                try {
                    ...
                    for(int i = 0 ; i < results.length(); i++){
                        ...
                        movies.add(movie);
                        //notify adap that a row was added
        ...
        client.get(url, params, new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    Log.i(TAG,
                            String.format("Loaded config with imageBaseUrl %s and posterSize %s",
